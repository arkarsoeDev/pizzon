...
(function ($) {
    ...
    $.fancyboxPlus.init = function () {
        ...
        outer.append(
            ...
            close = $('<a id="fbplus-close"><i class="fas fa-times"></i></a>'),
            title = $('<div id="fbplus-title"></div>'),

            nav_left = $('<a href="javascript:;" id="fbplus-left"><span class="fancy-ico" id="fbplus-left-ico"><i class="fas fa-angle-left"></i></span></a>'),
            nav_right = $('<a href="javascript:;" id="fbplus-right"><span class="fancy-ico" id="fbplus-right-ico"><i class="fas fa-angle-right"></i></span></a>')
        );
